...
class TextData:
    ...
    def loadCorpus(self, corpusname):
        ...
        if corpusname == 'LMbenchmark':
            ...
            if args['retrain_model'] == 'LM' or args['retrain_model'] == 'policy':
                self.fullSamplesPath = args['rootDir'] + '/model/LMdata.pkl'  # Full sentences length/vocab
            elif args['retrain_model'] == 'No':
                self.fullSamplesPath = './LMdata1.pkl'  # Full sentences length/vocab
    ...
    def saveDataset(self, filename):
        ...
        """
        with open(os.path.join(filename.replace('LMdata', 'LMdata1')), 'wb') as handle:
