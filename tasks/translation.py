...
from tasks import FairseqTask, register_task
...
class TranslationTask(FairseqTask):
    ...
    def valid_step(self, sample, model, criterion):
        ...
        if self.cfg.eval_bleu:
            sg = model.sequence_generator if hasattr(model, 'sequence_generator') else self.sequence_generator
            bleu, hyps,refs  = self._inference_with_bleu(sg, sample, model)
